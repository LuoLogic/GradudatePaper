...
\begin{table}
	...
	\resizebox{\linewidth}{!}{
		\begin{tabular}{llllllll} 
			\toprule[1.5pt]
			AUC       & GradCAM & GradCAM++ & XGradCAM & ScoreCAM       & GroupCAM & CAMERAS       & \textbf{MSG-CAM}          \\ 
			\hline
			插入 & 53.19   & 51.57     & 52.57    & \textbf{55.10} & 54.61    & 44.10         & 54.52           \\
			删除  & 11.52   & 12.16     & 11.53    & 11.43          & 11.21    & \textbf{8.01} & 9.78            \\
			总体  & 41.67   & 39.41     & 41.04    & 43.67          & 43.40    & 36.09         & \textbf{44.74}  \\
			\bottomrule[1.5pt]
		\end{tabular}
	}
\end{table}
...
\begin{table}
	\renewcommand{\arraystretch}{1.5}
	\centering
	\bicaption[\xiaosi 两个数据集上定点游戏实验平均准确率对比]{\wuhao 插入和删除实验指标对比}{\wuhao Comparison of mean accuracy of pointing game experiments on the two datasets}
	\wuhao
